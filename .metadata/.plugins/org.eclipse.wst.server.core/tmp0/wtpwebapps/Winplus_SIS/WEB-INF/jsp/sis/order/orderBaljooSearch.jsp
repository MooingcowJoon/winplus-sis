...
<script type="text/javascript">
	<%--
		※ 전역 변수 선언부  ( 발주서조회 orderBaljooSearch.jsp )  
		...
		■ Create Date : 2019-12-06 ( orderSheetSearch.jsp에서 복사후 분리)
		■ Modify Date :	 
	--%>
		...
		$.ajax({
			...
			,success : function(data){
				...
				if(data.isError){
					...
					/* 이메일 , 펙스 칼럼 숨김 처리 */
			        if 	( Called_program_nm ==  "주문서관리(본사/센터)" ) {
	...
	function initErpRibbon(){
        ...
        if 	( Called_program_nm ==  "발주서조회(센터)" ) {
        	ls_load_path  = "CT";
        }  if 	( Called_program_nm ==  "발주서(센터→협력사)_조회" ) {
        	ls_load_path  = "CT";
        } else {
        	ls_load_path  = "MK";   /* 직영점에서 센터or 외부협력사로 발주한 주문서조회 */
        }
    		...
    		erpRibbon = new dhtmlXRibbon({
    			...
    			, items : [
    				{type : "block", mode : 'rows', list : [
    						...
    						, {id : "print_erpGrid",  type : "button", text:'발주서출력',                              isbig : false, img : "menu/print.gif",  imgdis : "menu/print_dis.gif",  disable : true}		
    				]}	
    			]
    		});
        } else {
	...
	function initErpGrid(){
		erpGridColumns = [
				...
				, {id : "ORD_NO"           , label:["발주번호"          , "#select_filter"], type: "ro", width: "120", sort : "str", align : "center", isHidden : false, isEssential : true}
				...
				, {id : "IN_WARE_NM"       , label:["고객사"            , "#select_filter"], type: "ro", width: "100", sort : "str", align : "left",   isHidden : false, isEssential : true}
				...
				, {id : "GOODS_NM"         , label:["발주상품"          , "#text_filter"], type: "ro", width: "260", sort : "str", align : "left",   isHidden : false, isEssential : true}			
				...
				, {id : "ORD_TYPE_NM"      , label:["발주유형"          , "#select_filter"], type: "ro", width: "80" , sort : "str", align : "left", isHidden : false, isEssential : true}
				, {id : "ORD_STATE"        , label:["발주상태"          , "#text_filter"], type: "ro", width: "100", sort : "str", align : "left",   isHidden : true , isEssential : true}
				, {id : "ORD_STATE_NM"     , label:["발주상태"          , "#text_filter"], type: "ro", width: "100",  sort : "str", align : "left", isHidden : false, isEssential : true}
	...
	function searchErpGrid(){
        ...
        $.ajax({
			url : "/sis/order/getSearchBaljooList.do"
			,data : {
					    ...
					    , "LOGIN_MENU"             : scrn_MENU   /*  호출메뉴  CT: 발주서센터,  MK:발주서매장  */  
					}
			,method : "POST"
			,dataType : "JSON"
			,success : function(data){
	...
	function clearCustmrCondition(){
		$("#hidSurp_CD").val("");
		$("#Custmr_Name").val("전체조회");
	}
	...
	<div id="div_erp_contents_search" class="div_erp_contents_search" style="display:none">
		<table class="table_search" id="aaa">
			...
			<tr>
				...
				<th>협력사명</th>
				<td>
					<input type="hidden" id="hidSurp_CD" value="">
					<input type="text" id="Custmr_Name" name="Custmr_Name" readonly="readonly" onclick="clearCustmrCondition()" value="전체조회"/>
