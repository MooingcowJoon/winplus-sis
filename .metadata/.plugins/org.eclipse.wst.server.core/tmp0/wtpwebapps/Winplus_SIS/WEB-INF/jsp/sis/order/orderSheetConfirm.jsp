...
<script type="text/javascript">
	<%--
		※ 전역 변수 선언부  ( 긴급주문서영업승인  orderSheetConfirm.jsp ) 
		...
		erpRibbon = new dhtmlXRibbon({
			...
			, items : [
				{type : "block", mode : 'rows', list : [
						...
						, {id : "excel_erpGri5",  type : "button", text:'영업승인',                                isbig : false, img : "menu/add.gif",    imgdis : "menu/add_dis.gif",    disable : true}
	...
	function initErpGrid(){
		erpGridColumns = [
				...
				, {id : "SUPR_NM"          , label:["협력사명"          , "#select_filter"], type: "ro", width: "200", sort : "str", align : "left",   isHidden : true, isEssential : true}
