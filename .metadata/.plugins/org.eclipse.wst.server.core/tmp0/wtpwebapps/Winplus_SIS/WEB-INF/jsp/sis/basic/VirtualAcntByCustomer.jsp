...
<script type="text/javascript">
	...
	function init_total_layout() {
		total_layout = new dhtmlXLayoutObject({
			...
			, pattern : "3E"
			, cells : [
				{id: "a", text: "계좌 현황 ", header: true, fix_size : [true, true]}
				,{id: "b", text: "미드영역", header: false, fix_size : [true, true]}
				,{id: "c", text: "가상계좌 목록", header: false, fix_size:[true,true]}
			]
		});
		...
		<div id="div_top_layout_search" class="samyang_div" style="diplay:none;">
			<table id="tb_search" class="table">
				...
				<tr>
					...
					<td colspan="1"><input type="text" id="txtORGN_DIV_CD_NM" name="ORGN_DIV_CD_NM" value="${SearchInfo.ORGN_DIV_CD_NM}" class="input_common" readonly="readonly" style="text-align: center;width:85px;"></td>
					<th colspan="1">기관명(농협)</th>
					<td colspan="1">
						<input type="hidden" id="txtVRT_ORG_CD" name="VRT_ORG_CD" value="${SearchInfo.VRT_ORG_CD}">
						<input type="text" id="txtVRT_ORG_CD_NM" name="VRT_ORG_CD_NM" value="${SearchInfo.VRT_ORG_CD_NM}" class="input_common" readonly="readonly" style="text-align: center;width:85px;">
					</td>
					<th colspan="1">총 구좌</th>
					<td colspan="1"><input type="text" id="txtTOT_ACNT" name="TOT_ACNT" value="${SearchInfo.TOT_ACNT}" class="input_common" readonly="readonly" style="text-align: right;width:85px;"></td>
					<th colspan="1">발행 구좌</th>
					<td colspan="1"><input type="text" id="txtISSU_ACNT" name="ISSU_ACNT" value="${SearchInfo.ISSU_ACNT}" class="input_common" readonly="readonly" style="text-align: right;width:85px;"></td>
					<th colspan="1">남은 구좌</th>
					<td colspan="1"><input type="text" id="txtBAL_ACNT" name="BAL_ACNT" value="${SearchInfo.BAL_ACNT}" class="input_common" readonly="readonly" style="text-align: right;width:85px;"></td>
				</tr>
			</table>
		</div>
	</div>
