...
<script type="text/javascript">
	...
	function initErpLayout() {
		erpLayout = new dhtmlXLayoutObject({
			...
			, pattern : "2E"
			, cells : [
				{id: "a" , text: "조회조건" , header: true, height: 175, fix_size:[true, true]}
				, {id: "b", text: "", header: false}
			]
		});
		
		erpLayout.cells("a").attachObject("div_erp_search_part");
		erpLayout.cells("a").setHeight(180);
	...
	function initErpGrid() {
		erpGridColumns = [
  			...
  			, {id : "sup_name", label:["거래처명", "#rspan"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
  			, {id : "price", label:["청구금액", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
  			, {id : "non_price", label:["미청구금액", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
  			, {id : "total", label:["합계", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}          
		];
