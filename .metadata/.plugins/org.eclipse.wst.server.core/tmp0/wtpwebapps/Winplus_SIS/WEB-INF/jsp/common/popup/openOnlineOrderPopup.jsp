...
<script type="text/javascript">
	...
	function initerpPopupGrid(){
		erpPopupGridColumns = [
			...
			, {id : "GRUP_NM", label:["거래처그룹명"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "CUSTMR_NM", label:["거래처명"], type: "ro", width: "240", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "PUR_SALE_TYPE", label:["거래유형"], type: "ro", width: "80", sort : "str", align : "center", isHidden : true, isEssential : false}
			, {id : "PUR_SALE_NM", label:["거래유형명"], type: "ro", width: "80", sort : "str", align : "center", isHidden : false, isEssential : false}
			, {id : "USE_YN", label:["사용유무"], type: "ro", width: "60", sort : "str", align : "center", isHidden : false, isEssential : false, commonCode: ["YN_CD","YN"]}
			, {id : "GRUP_CD", label:["거래처그룹코드"], type: "ro", width: "90", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "CUSTMR_CD", label:["거래처코드"], type: "ro", width: "90", sort : "str", align : "center", isHidden : false, isEssential : false}              
		];
