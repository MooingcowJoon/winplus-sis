...
<script type="text/javascript">
	...
	function initErpSubLayout() {
		erpSubLayout = new dhtmlXLayoutObject({
			...
			, pattern : "3E"
			, cells: [
				{id: "a", text: "월별종합조회조건영역", header:false}
	...
	function SearchErpGrid() {
		...
		$.ajax({
			url : "/sis/report/MonByReport/getMonByTotalList.do"
			,data : paramMap
			,method : "POST"
			,dataType : "JSON"
	...
	<div id="div_erp_contents_search" class="div_layout_full_size div_erp_contents_search" style="display:none">
		<table class="tb_erp_common">
			...
			<tr>
				<th> 기    간 </th>
				<td colspan="3">
					<input type="text" id="searchDateFrom" name="searchDateFrom" class="input_common input_calendar_ym default_date" data-position="-1">
					 ~ <input type="text" id="searchDateTo" name="searchDateTo" class="input_common input_calendar_ym default_date" data-position="">
				</td>
			</tr>		
		</table>
	</div>
