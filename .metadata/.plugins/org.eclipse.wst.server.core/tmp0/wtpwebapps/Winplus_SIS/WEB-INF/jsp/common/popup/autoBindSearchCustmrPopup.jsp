...
<script type="text/javascript">
	...
	var erpPopupWindowsCell = parent.erpPopupWindows.window("autoBindSearchCustmrPopup");
	var erpLayout;
	var erpRibbon;
	var erpPopupGrid;
	...
	function initErpLayout(){
		erpLayout = new dhtmlXLayoutObject({
			...
			, pattern: "3E"
			, cells: [
				{id: "a", text: "조회조건영역", header:false, height:12}
	...
	function searchErpPopupCustmr(){
		...
		$.ajax({
			...
			,data : {
				...
				, "PUR_SALE_TYPE" : param_PUR_SALE_TYPE
