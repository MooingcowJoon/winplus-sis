...
<script type="text/javascript">
	...
	--%>
	var thisPopupWindow = parent.erpPopupWindows.window('orderPortalPopup');
	...
	function initErpLayout(){
		erpLayout = new dhtmlXLayoutObject({
			...
			, pattern: "3E"
			, cells: [
				  {id: "a", text: "${menuDto.menu_nm}", header:true, height:63}
	...
	function searchErpGrid(){
		...
		var scrin_OutWare_CD      = cmbOUT_WARE_CD.getSelectedValue();
		...
		$.ajax({
			...
			,data : {
				...
				, "PARAM_PROJ_CD"          : ""
				, "PARAM_IN_WARE_CD"       : ""
				, "PARAM_OUT_WARE_CD"      : scrin_OutWare_CD
				, "PARAM_SUPR_CD"          : ""
				, "PARAM_RESP_USER"        : ""
				, "PARAM_ORD_STATE"        : scrin_ORD_STATE
				, "PARAM_ORD_TYPE"         : LOGIN_ORD_TYPE        /* 1: 발주, 2:주문 */
			}
	...
	function initDhtmlXCombo(){
   		...
   		/* 출고창고(주문서등록그리드) */
   		cmbOUT_WARE_CD = $erp.getDhtmlXComboCommonCode('cmbOUT_WARE_CD',   'cmbOUT_WARE_CD',  'CENTER_CD',   177,  "모두조회",  false, cmbOUT_WARE_CD);
      	$erp.objReadonly("cmbOUT_WARE_CD");  
