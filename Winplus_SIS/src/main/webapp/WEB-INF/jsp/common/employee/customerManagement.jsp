...
<script type="text/javascript">
	...
	function initLeftLayout(){
		...
		erpGridColumns=[
   			...
   			, {id : "EMP_NO", label:["고객사코드"], type: "ro", width: "80", sort : "str", align : "center", isHidden : false, isEssential : false}
			, {id : "EMP_NM", label:["고객사명"], type: "ro", width: "115", sort : "str", align : "left", isHidden : false, isEssential : false}
	...
	function searchLeftGrid(){
		...
		$.ajax({
			url : "/common/employee/getCustomerList.do"
		...
		<div id="div_right_table" class="samyang_div" style="display:none">
			<table id="table_data" class="tb_erp_common">
				<colgroup>
					...
					<tr>
						<th><span class="span_essential">*</span>고객사명</th>
						<td>
					...
					<tr>
						<th><span class="span_essential">*</span>고객사번호</th>
						<td>
