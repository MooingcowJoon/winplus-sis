...
<script type="text/javascript">
	<%--
		※ 전역 변수 선언부   ( openGoodsRetCsPopup.jsp 센터반품 전용 상품팝업 )
	...
	function search_erpMiddGrid(){
		...
		$.ajax({
			  url     : "/sis/order/getBanpumBarcodePriceList.do"    /* 2020-01-23 <= getSearchMasterBarcodeCustomerLowestPriceList */
			,data     : {
							  "PARAM_BCD_NM"       : goods_nm
							, "PARAM_ORGN_CD"      : param_ORGN_CD   /* 협력사  */
		 	            }
			,method   : "POST"
			,dataType : "JSON"
