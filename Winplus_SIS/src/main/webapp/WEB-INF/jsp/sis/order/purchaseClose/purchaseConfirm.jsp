...
<script type="text/javascript">
	...
	function initErpGrid(){
		erpGridColumns = [
			...
			,{id : "CUSTMR_NM", label:["협력사", "#rspan"], type: "ro", width: "150", sort : "str", align : "center", isHidden : true, isEssential : false}
		];
		...
		erpGrid.attachFooter('총 합계,#cspan,#cspan,#cspan,<div id="totalSuprAmt" style="text-align:right;">0</div>,<div id="totalVat" style="text-align:right;">0</div>,<div id="totalTotAmt" style="text-align:right;">0</div>,,#cspan,<div id="totalCustmrAmt" style="text-align:right;">0</div>,<div id="totalCalcAmt" style="text-align:right;">0</div>',[tot_style,"","","",text_style,text_style,text_style,text_style,"",text_style,text_style]);
		erpGrid.attachFooter('과세합계,#cspan,#cspan,#cspan,<div id="totalTaxaSuprAmt" style="text-align:right;">0</div>,<div id="totalTaxaVat" style="text-align:right;">0</div>,<div id="totalTaxaTotAmt" style="text-align:right;">0</div>,,#cspan,#cspan,#cspan',[tot_style,"","","",text_style,text_style,text_style,text_style]);
		erpGrid.attachFooter('면세합계,#cspan,#cspan,#cspan,<div id="totalFreeSuprAmt" style="text-align:right;">0</div>,<div id="totalFreeVat" style="text-align:right;">0</div>,<div id="totalFreeTotAmt" style="text-align:right;">0</div>,,#cspan,#cspan,#cspan',[tot_style,"","","",text_style,text_style,text_style,text_style]);
	...
	function calculateFooterValues(){
		...
		document.getElementById("totalTaxaSuprAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("TAXA_SUPR_AMT")));
		document.getElementById("totalTaxaVat").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("TAXA_VAT")));
		document.getElementById("totalTaxaTotAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("TAXA_PAY_SUM_AMT")));
		document.getElementById("totalFreeSuprAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("FREE_SUPR_AMT")));
		document.getElementById("totalFreeTotAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("FREE_SUPR_AMT")));
		document.getElementById("totalCustmrAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("CLSE_TOT_AMT")));
		document.getElementById("totalCalcAmt").innerHTML = moneyType(sumColumn(erpGrid.getColIndexById("CALC_AMT")));
	}
				...
				, success : function(data){
					...
					if(data.isError){
						...
						if($erp.isEmpty(gridDataList)){
							...
							erpGrid.groupBy(erpGrid.getColIndexById("CUSTMR_NM"),["#title","#cspan","#cspan","#cspan","#stat_total","#stat_total","#stat_total","","#cspan","#stat_total","#stat_total"]);
