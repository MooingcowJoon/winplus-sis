...
<script type="text/javascript">
	...
	var erpPopupWindowsCell = parent.erpPopupWindows.window("openDoubleGroupPointPopup");
	var erpLayout;
	var erpRibbon;
	var erpGrid;
	var erpGridColumns;
	...
	$(document).ready(function(){
		if(erpPopupWindowsCell){
			erpPopupWindowsCell.setText("이종상품그룹조회");
		}
	...
	function initErpGrid(){
		erpGridColumns = [
			...
			, {id : "BUDL_NM", label:["타이틀", "#rspan"], type: "ro", width: "185", sort : "str", align : "left", isHidden : false, isEssential : true}
			, {id : "BUDL_STRT_DATE", label:["시작일", "#rspan"], type: "ro", width: "85", sort : "date", align : "center", isHidden : false, isEssential : true}
			, {id : "BUDL_END_DATE", label:["종료일", "#rspan"], type: "ro", width: "85", sort : "date", align : "center", isHidden : false, isEssential : true}
			, {id : "POINT_SAVE_EX_YN", label:["포인트적립", "#rspan"], type: "combo", width: "85", sort : "str", align : "center", isHidden : false, isEssential : false, isDisabled : true, commonCode : ["POINT_SAVE_EX_YN"]}
			, {id : "BUDL_CD", label:["번들코드", "#rspan"], type: "ro", width: "90", sort : "str", align : "center", isHidden : true, isEssential : true}
		];
	...
	function searchErpGrid(){
		...
		$.ajax({
			url : "/common/popup/getOpenDoubleGroupPointPopup.do"
			,data : {
	...
	function initDoubleInfo(){
		var ORGN_CD = "${param.ORGN_CD}";
		var addData = document.getElementById("table_search");
		$erp.clearInputInElement(addData);
		$erp.dataAutoBind(addData, ORGN_CD);
	}
</script>
</head>
<body>
