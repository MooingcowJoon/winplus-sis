...
<script type="text/javascript">
	...
	**********************************************************************
	...
	function searchErpGrid(){
		...
		$.ajax({
			url : "/common/system/code/getTreeCodeList.do"
			,data : {
				"TREE_CODE" : TREE_CODE
				, "USE_YN" : use_yn
			}
	...
	function saveErpGrid(){
		...
		$.ajax({
			url : "/common/system/code/cudTreeCodeList.do"
			,data : paramData
			,method : "POST"
			,dataType : "JSON"
			,success : function(data){
	...
	**********************************************************************
	...
	function searchErpDetailGrid(TREE_CODE){
		...
		$.ajax({
			url : "/common/system/code/getTreeDetailCodeList.do"
			,data : {
	...
	function saveErpDetailGrid(){
		...
		$.ajax({
			url : "/common/system/code/cudTreeDetailCodeList.do"
			,data : paramData
			,method : "POST"
			,dataType : "JSON"
			,success : function(data){
