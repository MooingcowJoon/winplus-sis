   ...
   --%>
	   ...
	   function initErpGrid() {
	      ...
	      erpAllGridColumns = [ //id값 변경필수!
	         ...
	         , {id : "GRUP_NM", label:["구분", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
	         ...
	         , {id : "ORGN_DIV_CD", label:["분류코드", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : true, isEssential : false}
	         , {id : "ORGN_CD", label:["분류코드", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : true, isEssential : false}
	         ...
	         , {id : "SALE_GOODS_ETC_AMT_TOT", label:["기타합계", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
	      ...
	      erpTaxFreeGrid.attachEvent("onRowDblClicked", function(rId){
	    	  var grup_cd = this.cells(rId, this.getColIndexById("GRUP_CD")).getValue();
	      ...
	      erpTaxGrid.attachEvent("onRowDblClicked", function(rId){
	    	  var grup_cd = this.cells(rId, this.getColIndexById("GRUP_CD")).getValue();
	   ...
	   function SearchErpGrid(grid_data, grup_cd) {
			...
			var GRUP_CD = grup_cd;
		   	 ...
		   	 $.ajax({
					url: "/sis/report/dayByReport/dayByGoodsGroupVatList.do"
					, data : {
						"PUR_CD_NM" : PUR_CD_NM
