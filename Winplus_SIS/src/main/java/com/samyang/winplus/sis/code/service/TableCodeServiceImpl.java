...
public class TableCodeServiceImpl implements TableCodeService {
	...
	@Override
	public List<Map<String, Object>> getSaleRegTypeList(Map<String, Object> paramMap) {
		return tableCodeDao.getSaleRegTypeList(paramMap);
	}
	...
	@Override
	public List<Map<String, Object>> getOrgnCustomerList(Map<String, Object> paramMap) {
		return tableCodeDao.getOrgnCustomerList(paramMap);
	}
