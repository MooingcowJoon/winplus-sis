...
@Repository("CustmrSearchDao")
public interface CustmrSearchDao {
	...
	/**
	  ...
	  * @throws Exception
	  */	
	List<Map<String, Object>> getCustmrGoodsSearch(Map<String, Object> paramMap);
	...
	/**
	  ...
	  * @throws Exception
	  */	
	List<Map<String, Object>> getCustmrGoodsDetailSearch(Map<String, Object> paramMap);
	 ...
	 * @throws Exception
	 */
	int saveAddCustmrGoodsSearch(Map<String, Object> paramMap);
	 ...
	 * @throws Exception
	 */
	int saveUpdateCustmrGoodsSearch(Map<String, Object> paramMap);
}
