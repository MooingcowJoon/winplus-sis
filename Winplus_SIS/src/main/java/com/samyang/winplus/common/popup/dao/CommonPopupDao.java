...
public interface CommonPopupDao {
	 ...
	 * </pre>   
	 * @author bumseok.oh
	 * @Method Name : searchDlvBsnPrices
	 * @param paramMap
	 * @return
	 * @throws SQLException
	 * @throws Exception
	...
	List<Map<String, Object>> searchFacYPopup(Map<String, Object> paramMap) throws SQLException, Exception;
	...
	List<Map<String, Object>> searchFacNPopup(Map<String, Object> paramMap) throws SQLException, Exception;
	...
	/**
	  ...
	  * @exception Exception
	  */
	List<Map<String, Object>> searchCallHistoryPopup2(Map<String, Object> paramMap) throws SQLException, Exception;
	...
	/**
	  * getAcceptDaySumManagementPopup - 받는날 관리 합산 팝업
	  * @author mi
	  * @param paramMap
	  * @return List<Map<String, Object>>
	  * @exception SQLException
	...
	/**
	  * getResourcesBuyRegisterPopup - 자재매입 - 자재매입등록 팝업 
	  * @author mi
	  * @param paramMap
	  * @return Map<String, Object>
	  * @exception SQLException
...
///////////////////////////////////윈플러스 개발 추가///////////////////////////////////
	 ...
	 * @throws Exception
	 */
	List<Map<String,Object>> getGoodsCategoryTreeList(Map<String, Object> paramMap) throws SQLException, Exception;
	...
	/**
	 * getGoodsList - [공통] - 상품조회 팝업 - 디테일 데이터 조회
	 * 
	 * @author 정혜원
	 * @param paramMap
	 * @return Map<String,Object>
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGoodsSales(Map<String, Object> paramMap);
	...
	* @throws Exception
	*/
	Map<String, Object> getGoodsSalesUnder(Map<String, Object> paramMap);
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGoodsStock(Map<String, Object> paramMap);
	...
	*/
	 ...
	 * @throws Exception
	 */
	List<Map<String, Object>> getGoodsGroupList(Map<String, Object> paramMap);
	
	/**
	 * getGoodsGroupCD - [공통] - 상품집합관리팝업 - 상품집합그룹코드 조회
	 * 
	 * @param paramMap
	 * @author 정혜원
	 * @return Map<String, Object>
	 ...
	 * @throws Exception
	 */
	int addGoodsGroupList(Map<String, Object> paramMap);
	 ...
	 * @throws Exception
	 */
	int deleteGoodsGroupList(Map<String, Object> paramMap);
	 ...
	 * @throws Exception
	 */
	int updateGoodsGroupList(Map<String, Object> paramMap);
	...
	/**
	 * updateGoodsGroupDetailList - [공통] - 상품집합관리팝업 - 상품집합그룹상세상품 업데이트
	 * 
	 * @author 정혜원
	 * @param paramMap
	 * @return Integer
	...
	/**
	  * getSearchMasterBarcodePriceList - 바코드마스터 && 상품마스트에서 상품및  바코드가져온다
	  * @author 손경락
	  * @param paramMap
	  * @return Integer
	  * @exception SQLException
	...
	/**
	  * getSearchComEmpNo - 사원정보 사원정보에서 사원번호,성명,부서,이메일,연락처를 가져온다
	  * @author 손경락
	  * @param paramMap
	  * @return Integer
	  * @exception SQLException
	 ...
	 /**
	  * getSearchMemberList - 회원조회 팝업 - 회원조회
	  * @author 정혜원
	  * @param paramMap
	  * @return List<Map<String, Object>>
	  * @exception SQLException
	  ...
	  * @exception Exception
	  */
	 List<Map<String, Object>> getPasteGrupGoodsList(List<Map<String, Object>> paramMapList);
