...
public interface PurchaseManagementDao {
	...
	List<Map<String, Object>> getPurchaseStatusDetailSearch(Map<String, String> paramMap) throws SQLException, Exception;
	...
	/**
	  ...
	  * @throws Exception
	  */
	List<Map<String, Object>> getPurchaseAmtAdjustment(Map<String, String> paramMap);
	 ...
	 * 구매관리 - 구매금액조정 - 디테일조회
	  ...
	  * @throws Exception
	  */
	List<Map<String, Object>> getPurchaseAmtDetailAdjustment(Map<String, String> paramMap);
	...
	/**
	  ...
	  * @return Integer
	  */
	int savePurchaseAmtAdjustment(Map<String, Object> paramMap);
	...
	/**
	  ...
	  * @return Integer
	  */
	int updatePurchaseAmtAdjustment(Map<String, Object> paramMap);
