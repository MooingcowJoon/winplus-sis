...
// 			        		             , {id : "delete_grid", 	type : "button", text:'<spring:message code="ribbon.delete" />', 	isbig : false, img : "menu/delete.gif", imgdis : "menu/delete_dis.gif", disable : true}
	...
	function init_bottom_layout(){
		...
		var grid_Columns = [
							  {id : "MOVE_NO", label:["이동번호", "#text_filter"], type: "ro", width: "80", sort : "str", align : "center"}
							...
							, {id : "_______", label:["진행상태", "#text_filter"], type: "combo", width: "80", sort : "str", align : "center", commonCode : "MOVE_STATE"}
