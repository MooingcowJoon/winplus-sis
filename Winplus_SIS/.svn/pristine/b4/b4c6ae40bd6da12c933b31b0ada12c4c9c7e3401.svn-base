...
/* #Customized (김종훈) : 풀스크린 옵션 파라메터 추가 - 백업 시작 */
/* function dhtmlXCellTop(base, offsets) { */
/* #Customized (김종훈) : 풀스크린 옵션 파라메터 추가 - 백업 끝 */
/* #Customized (김종훈) : 풀스크린 옵션 파라메터 추가 - 시작 */
function dhtmlXCellTop(base, offsets, fs_mode) {
/* #Customized (김종훈) : 풀스크린 옵션 파라메터 추가 - 끝 */
	...
	if(fs_mode != undefined && fs_mode != null && fs_mode === true){
...
// top-level progress
dhtmlXCellTop.prototype.progressOn = function(gubn) {
	...
	if (this.conf.skin == "material" && (window.dhx4.isFF || window.dhx4.isChrome || window.dhx4.isOpera || window.dhx4.isEdge)) {
		...
		if(gubn != undefined){
			if(gubn == 'excel'){
				t2.className = "dhxcelltop_progress_excel";
			}else if(gubn == 'save'){
				t2.className = "dhxcelltop_progress_save";
			}else if(gubn == 'fee'){
				t2.className = "dhxcelltop_progress_fee";
			}else if(gubn == 'cms'){
				t2.className = "dhxcelltop_progress_cms";
			}else if(gubn == 'send'){
				t2.className = "dhxcelltop_progress_send";
			}
		}else{
...
dhtmlXCellTop.prototype.progressOff = function(gubn) {
	...
	for (var a in p) {
		/*커스터마이징 : 프로그레스 오프*/
		if(gubn!==undefined && gubn=='excel'){
			try{
				$('.dhxcelltop_progress_excel').remove();
				$('.dhxcelltop_progress').remove();
			}
			catch(e){}
		}else if(gubn!==undefined && gubn=='cms'){
			try{
				$('.dhxcelltop_progress_cms').remove();
				$('.dhxcelltop_progress').remove();
			}
			catch(e){}
		}else if(gubn!==undefined && gubn=='save'){
			try{
				$('.dhxcelltop_progress_save').remove();
				$('.dhxcelltop_progress').remove();
			}
			catch(e){}
		}else if(gubn!==undefined && gubn=='send'){
			try{
				$('.dhxcelltop_progress_send').remove();
				$('.dhxcelltop_progress').remove();
			}
			catch(e){}
		}else if(gubn!==undefined && gubn=='fee'){
			try{
				$('.dhxcelltop_progress_fee').remove();
				$('.dhxcelltop_progress').remove();
			}
			catch(e){}
		}else{
