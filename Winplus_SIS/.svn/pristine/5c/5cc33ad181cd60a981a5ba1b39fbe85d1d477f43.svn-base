...
<script type="text/javascript">
	...
	function initErpGrid() {
		erpGridColumns = [ //id값 변경필수!
		    {id : "No", label:["순번"], type: "ro", width: "30", sort : "str", align : "left", isHidden : false, isEssential : false}
            , {id : "emp_nm", label:["담당자명"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}              
			...
			, {id : "goods_bcode", label:["재고매입"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "goods_bcode", label:["회계매입"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "goods_bcode", label:["지급현금"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "goods_bcode", label:["지급어음"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
			, {id : "goods_bcode", label:["지급합계"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
			...
			, {id : "goods_bcode", label:["비고"], type: "ro", width: "200", sort : "str", align : "left", isHidden : false, isEssential : false}
        ];
	...
	function SearchErpGrid() {
		...
		imply_zero = document.getElementById("imply_zero").checked;
		imply_stopCustmr = document.getElementById("imply_stopCustmr").checked;
		
		$.ajax({
			url: "/sis/report/PurchaseManagement/getDebtByCustmrList.do"
			, data: {
				...
				, "project" :project
				, "Add_sign" :Add_sign
				, "imply_zero" :imply_zero
				, "imply_stopCustmr" :imply_stopCustmr
			}
			, method: "POST"
			, dataType: "JSON"
	...
	function openSearchOrgnTreePopup() {
		...
		var onConfirm = function(id,nm){
			...
			document.getElementById("department").value = nm;
    	}
		...
		<table id="tb_erp_price_data" class="tb_erp_common">
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" id="imply_zero" name="imply_zero" checked="checked"/>
					<label for="imply_zero">잔액0포함</label>
					<input type="checkbox" id="imply_stopCustmr" name="imply_stopCustmr" checked="checked"/>
					<label for="imply_stopCustmr">사용중단거래처포함</label>
				</td>
			</tr>
			<tr>
				<th>창 고</th>
				<td>
					...
					<input type="text" id="WareHouse" name="WareHouse" readonly="readonly" disabled="disabled"/>
			...
			<tr>
				...
				<td>
					...
					<input type="text" id="department" name="department" readonly="readonly" disabled="disabled"/>
				...
				<td>
					...
					<input type="text" id="Project" name="Project" readonly="readonly" disabled="disabled"/>
