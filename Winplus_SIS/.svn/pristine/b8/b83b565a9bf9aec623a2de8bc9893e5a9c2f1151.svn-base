...
<script type="text/javascript">
	...
	function initErpGroupGrid() {
		erpGroupGridColumns = [
		  ...
		  , {id : "ORGN_CD", label:["조직명", "#rspan"], type: "combo", width: "80", sort : "str", align : "left", isHidden : false, isDisabled : true, isEssential : false, commonCode : ["ORGN_CD", "", "", "", "", "MK"]}
		  , {id : "GRUP_CD", label:["상품그룹코드", "#rspan"], type: "ro", width: "100", sort : "int", align : "center", isHidden : false, isEssential : false}
		  , {id : "GRUP_NM", label:["상품그룹명", "#rspan"], type: "ed", width: "190", sort : "int", align : "left", isHidden : false, isEssential : true}
		  , {id : "USE_YN", label:["사용여부", "#rspan"], type: "combo", width: "80", sort : "str", align : "center", isHidden : false, isEssential : true, commonCode : ["USE_CD","YN"]}
		  , {id : "RESP_USER", label:["담당자", "#rspan"], type: "ro", width: "100", sort : "int", align : "center", isHidden : false, isEssential : false}
		  , {id : "CDATE", label:["등록일시", "#rspan"], type: "ro", width: "140", sort : "int", align : "center", isHidden : false, isEssential : false}
		];
...
// 		 });
	...
	function initErpGoodsGrid() {
		...
		, {id : "GRUP_CD", label:["상품그룹코드", "#rspan"], type: "ro", width: "100", sort : "str", align : "left", isHidden : false, isEssential : false}
		, {id : "OBJ_CD", label:["바코드", "#rspan"], type: "ro", width: "120", sort : "str", align : "left", isHidden : false, isEssential : false}
		, {id : "SEQ", label:["순번", "#rspan"], type: "ro", width: "120", sort : "str", align : "center", isHidden : true, isEssential : false}
		, {id : "OBJ_NM", label:["상품명", "#rspan"], type: "ro", width: "300", sort : "str", align : "left", isHidden : false, isEssential : false}
		, {id : "USE_YN", label:["사용여부", "#rspan"], type: "combo", width: "80", sort : "str", align : "center", isHidden : false, isEssential : true, commonCode : ["USE_CD","YN"]}
   		];
