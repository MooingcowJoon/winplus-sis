...
<script type="text/javascript">
	...
	function init_top_layout(){
		...
		cmbDATE.addOption([
			...
			,{value: "ORDDATE", text: "주문일", selected: true}
		]);
...
// 								, {id : "excel_grid_upload", type : "button", text:'<spring:message code="ribbon.upload" />', isbig : false, img : "menu/excel.gif", imgdis : "menu/excel_dis.gif", disable : true, unused : false}
		...
		ribbon.attachEvent("onClick", function(itemId, bId){
			if(itemId == "search_grid"){
				...
				$erp.exportGridToExcel({
					...
					, "excludeColumnIdList" : ['NO','BCD_CD','TEL_ORD_CD','GRUP_INDEX','GOODS_NO','UNIQUE_INDEX','GRUP_INDEX']
	...
	function init_bot_layout() {
		grid_Columns = [
						...
						, {id : "ORD_STATE", label:["주문 상태"], type : "combo", width : "120", sort : "str", align : "center", isHidden : false, isEssential : false, isDisabled : true, commonCode : ["DELI_ORD_STATE"]}
