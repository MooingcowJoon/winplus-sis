...
<script type="text/javascript">
	...
	function initErpGrid(){
		erpGridColumns = [
			...
			, {id : "REMK"             , label:["적요"              , "#text_filter"], type: "ed"  , width: "100", sort : "str", align : "right",  isHidden : false, isEssential : false}
	...
	function openSearchCustmrGridPopup() { // this는 클릭시 열리는 팝업창이다.
		...
		var onRowSelect = function(id, ind) {
			document.getElementById("hidSurp_CD").value = this.cells(id, this.getColIndexById("sup_code")).getValue();
